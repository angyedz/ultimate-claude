/**
 * ProcessManager — spawns Claude Code in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The ultimate-claude binary (e.g. 'ultimate-claude')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'ultimate-claude';
