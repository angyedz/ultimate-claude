...
export const commands: SlashCommand[] = [
  ...
  { name: 'wiki', description: 'Initialize and inspect the UltimateClaude project wiki', category: 'context', args: '[init|status]' },
  ...
  { name: 'plugin', description: 'Manage UltimateClaude plugins', category: 'tools' },
  ...
  { name: 'statusline', description: "Set up UltimateClaude's status line UI", category: 'customization' },
  ...
  { name: 'stickers', description: 'Order UltimateClaude stickers', category: 'customization' },
  ...
  { name: 'doctor', description: 'Diagnose and verify your UltimateClaude installation and settings', category: 'diagnostics' },
  { name: 'stats', description: 'Show your usage statistics and activity', category: 'diagnostics' },
  { name: 'insights', description: 'Generate a report analyzing your UltimateClaude sessions', category: 'diagnostics' },
  { name: 'release-notes', description: 'View release notes', category: 'diagnostics' },
  { name: 'feedback', description: 'Submit feedback about UltimateClaude', category: 'diagnostics', args: '[report]' },
]
