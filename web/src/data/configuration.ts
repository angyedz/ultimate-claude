...
export const settingsFiles: SettingsFile[] = [
  {
    path: '~/.ultimate-claude/settings.json',
    scope: 'user',
    notes: 'Default global settings path for every project on the machine; ULTIMATE_CLAUDE_CONFIG_DIR moves this under the configured config home.',
  },
  {
    path: '.ultimate-claude/settings.json',
    scope: 'project',
  ...
  {
    path: '.ultimate-claude/settings.local.json',
    scope: 'local',
    notes: 'Per-machine overrides for one project; typically gitignored.',
  },
  {
    path: '~/.ultimate-claude/keybindings.json',
    scope: 'user',
    notes: 'Default keyboard shortcut overrides path; ULTIMATE_CLAUDE_CONFIG_DIR moves this under the configured config home.',
  },
  {
...
export const envVars: EnvVar[] = [
  ...
  { name: 'ULTIMATE_CLAUDE_CONFIG_DIR', description: 'Preferred config directory override. Defaults to ~/.ultimate-claude when unset.' },
  { name: 'CLAUDE_CONFIG_DIR', description: 'Legacy config directory override. Used only when ULTIMATE_CLAUDE_CONFIG_DIR is unset.' },
