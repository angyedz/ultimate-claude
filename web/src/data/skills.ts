...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    description:
      'Customize keyboard shortcuts: rebind keys, add chord bindings, or modify your keybindings file (default: ~/.ultimate-claude/keybindings.json; override via ULTIMATE_CLAUDE_CONFIG_DIR).',
  },
]
