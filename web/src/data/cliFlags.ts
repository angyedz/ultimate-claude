...
export const subcommands: Subcommand[] = [
  {
    name: 'mcp',
    usage: 'ultimate-claude mcp [add|remove|list|doctor]',
    description: 'Manage MCP server configuration from the command line.',
  },
  {
    name: 'ssh',
    usage: 'ultimate-claude ssh <host> [dir]',
    description: 'Run UltimateClaude on a remote host over SSH. Deploys the binary and tunnels API auth back through your local machine — no remote setup needed.',
  },
]
