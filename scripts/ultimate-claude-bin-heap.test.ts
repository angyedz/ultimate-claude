...
const BIN_PATH = join(import.meta.dir, '..', 'bin', 'ultimate-claude')

describe('ultimate-claude launcher heap guard', () => {
  ...
  test('keeps user and troubleshooting escape hatches', () => {
    ...
    expect(source).toContain('ULTIMATE_CLAUDE_DISABLE_HEAP_RELAUNCH')
    expect(source).toContain('ULTIMATE_CLAUDE_NODE_MAX_OLD_SPACE_SIZE_MB')
