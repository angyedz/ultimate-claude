...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/ultimateclaude.proto')
...
async function main() {
  ...
  const client = new ultimateclaudeProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mClaude Code gRPC CLI\x1b[0m')
