...
test('canonicalStub keys on the src-relative path across separators', () => {
  expect(canonicalStub('/home/runner/work/ultimate-claude/ultimate-claude/src/commands/dream/dream.ts')).toBe(
    'src/commands/dream/dream',
  )
  // Windows separators normalize to the same key.
  expect(canonicalStub('C:\\repo\\ultimate-claude\\src\\commands\\dream\\dream.ts')).toBe(
    'src/commands/dream/dream',
  )
})
...
test('collectBundleStubs keeps spaced paths intact in the comment marker', () => {
  const bundle = `// missing-module-stub:/home/jane doe/ultimate-claude/src/utils/foo.js\nvar foo = {};`
