...
const PROTO_PATH = path.resolve(import.meta.dirname, '../proto/ultimateclaude.proto')
...
const ultimateclaudeProto = protoDescriptor.ultimateclaude.v1
...
export class GrpcServer {
  ...
  constructor() {
    ...
    this.server.addService(ultimateclaudeProto.AgentService.service, {
      ...
      try {
        if (clientMessage.request) {
          ...
          engine = new QueryEngine({
            ...
            mcpClients: [],
            // Register Claude Code's built-in agents (general-purpose,
