  ...
  z
    ...
    .describe(
      'Source for loading filesystem-based settings. ' +
        "'user' - Global user settings (~/.ultimate-claude/settings.json). " +
        "'project' - Project settings (.ultimate-claude/settings.json). " +
        "'local' - Local settings (.ultimate-claude/settings.local.json).",
    ),
)
