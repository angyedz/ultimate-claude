...
export type PermissionUpdate = ({
  ...
  type: "setMode"
  mode: "default" | "acceptEdits" | "bypassPermissions" | "fullAccess" | "plan" | "dontAsk" | "turbo"
  destination: "userSettings" | "projectSettings" | "localSettings" | "session" | "cliArg"
}) | ({
  type: "addDirectories"
  directories: string[]
...
export type PermissionMode = "default" | "acceptEdits" | "bypassPermissions" | "fullAccess" | "plan" | "dontAsk" | "turbo"
...
export type AgentDefinition = {
  ...
  permissionMode?: "default" | "acceptEdits" | "bypassPermissions" | "fullAccess" | "plan" | "dontAsk" | "turbo"
}

/** Source for loading filesystem-based settings. 'user' - Global user settings (~/.ultimate-claude/settings.json). 'project' - Project settings (.ultimate-claude/settings.json). 'local' - Local settings (.ultimate-claude/settings.local.json). */
