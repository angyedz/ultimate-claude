...
describe('/auto-fix command prompt', () => {
  test('points project and local settings at canonical .ultimate-claude paths', async () => {
    ...
    expect(text).toContain('.ultimate-claude/settings.json')
    expect(text).toContain('.ultimate-claude/settings.local.json')
