 ...
 *
 * Usage:
 *   ultimate-claude --provider openai --model gpt-4o
 *   ultimate-claude --provider gemini --model gemini-2.0-flash
 *   ultimate-claude --provider mistral --model ministral-3b-latest
 *   ultimate-claude --provider ollama --model llama3.2
 *   ultimate-claude --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `ultimate-claude --model <name>` should work standalone so users can
