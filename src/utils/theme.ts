...
export type Theme = {
  ...
  // Claude Code brand accent (gitlawb orange). Values MUST be rgb() strings in
...
const lightTheme: Theme = {
  ...
  suggestion: 'rgb(209,87,0)', // Brand/Ember orange
...
const lightDaltonizedTheme: Theme = {
  ...
  inactiveShimmer: 'rgb(142,142,142)', // Lighter gray for shimmer effect
  subtle: 'rgb(175,175,175)', // Light gray
  suggestion: 'rgb(200,100,0)', // Brand/Ember orange
...
const darkTheme: Theme = {
  ...
  claude: 'rgb(255,122,26)', // Claude Code brand orange
  claudeShimmer: 'rgb(255,177,95)', // Lighter brand orange for shimmer effect
  brand: 'rgb(255,122,26)', // Claude Code brand orange
  ...
  suggestion: 'rgb(255,122,26)', // Brand/Ember orange
...
const darkDaltonizedTheme: Theme = {
  ...
  inactiveShimmer: 'rgb(193,193,193)', // Lighter gray for shimmer effect
  subtle: 'rgb(80,80,80)', // Dark gray
  suggestion: 'rgb(255,150,40)', // Brand/Ember orange
