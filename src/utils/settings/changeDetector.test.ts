...
const pathsBySource: Record<SettingSource, string | null> = {
  userSettings: normalize('/tmp/ultimate-claude/user/settings.json'),
  projectSettings: normalize('/tmp/ultimate-claude/project/.ultimate-claude/settings.json'),
  localSettings: normalize('/tmp/ultimate-claude/project/.ultimate-claude/settings.local.json'),
  flagSettings: null,
  policySettings: normalize('/tmp/ultimate-claude/managed/managed-settings.json'),
}
...
async function importFreshModule(): Promise<SettingsChangeDetectorModule> {
  ...
  activeDetector._setDependenciesForTesting({
    ...
    getManagedSettingsDropInDir: () =>
      normalize('/tmp/ultimate-claude/managed/managed-settings.d'),
