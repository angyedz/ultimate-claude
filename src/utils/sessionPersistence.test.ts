...
describe('sessionPersistence', () => {
  const testSessionDir = join(process.env.TEMP_DIR ?? '/tmp', 'ultimate-claude-test-sessions')

  beforeEach(async () => {
    process.env.ULTIMATE_CLAUDE_TEST_SESSIONS_DIR = testSessionDir
  ...
  afterEach(() => {
    delete process.env.ULTIMATE_CLAUDE_TEST_SESSIONS_DIR
  })
