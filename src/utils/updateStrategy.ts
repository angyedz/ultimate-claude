...
/**
 * How the *currently running* Claude Code installation should be updated.
 *
 ...
 * build the user is running. Custom-PACKAGE_URL builds (Claude Code's
 * `@gitlawb/ultimate-claude`) are safe to self-update.
 *
 * Shared by the `ultimate-claude update` CLI and the `/update` slash command so both
