 ...
 * (e.g. "@gitlawb/ultimate-claude@latest") with the given package manager.
 */
export function getGlobalInstallArgs(
  ...
  switch (pm) {
    ...
    case 'yarn':
      ...
      // for the documented ultimate-claude install path.
...
/**
 * Detect which package manager owns the currently running Claude Code install.
 *
 * Strategy:
