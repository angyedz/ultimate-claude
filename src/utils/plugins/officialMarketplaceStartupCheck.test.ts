...
mock.module('../config.js', () => ({
  ...
  getManagedClaudeRulesDir: () => '/tmp/ultimate-claude-managed-rules',
  getMemoryPath: () => '/tmp/ultimate-claude-memory.md',
  getOrCreateUserID: () => 'test-user-id',
  getProjectPathForConfig: () => '/tmp/ultimate-claude-project-config.json',
  getRemoteControlAtStartup: () => false,
  getUserClaudeRulesDir: () => '/tmp/ultimate-claude-user-rules',
...
mock.module('./marketplaceManager.js', () => ({
  ...
  getMarketplacesCacheDir: () => '/tmp/ultimate-claude-marketplaces',
  ...
  test('uses known marketplaces as the installed source of truth', async () => {
    knownMarketplaces = {
      'claude-plugins-official': {
        installLocation: '/tmp/ultimate-claude-marketplaces/claude-plugins-official',
      },
    }
