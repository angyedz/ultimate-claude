...
export const ULTIMATE_CLAUDE_RELEASES_URL =
  'https://github.com/Gitlawb/ultimate-claude/releases'
...
export function getReleaseTagUrl(version: string = publicBuildVersion): string {
  return `${ULTIMATE_CLAUDE_RELEASES_URL}/tag/v${normalizePublicVersion(version)}`
}
