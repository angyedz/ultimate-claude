/**
 * Claude Code brand identity — single source of truth for the product name,
...
export const BRAND_NAME = 'Claude Code'
 ...
 *   █▄█ █▄▄  █  █ █ ▀ █ █▀█  █  ██▄   █▄▄ █▄▄ █▀█ █▄█ █▄▀ ██▄
 */
export const WORDMARK_ULTIMATE = [
  '█ █ █   ▀█▀ █ █▀▄▀█ ▄▀█ ▀█▀ █▀▀',
  '█▄█ █▄▄  █  █ █ ▀ █ █▀█  █  ██▄',
] as const

/** @deprecated Use WORDMARK_ULTIMATE instead */
export const WORDMARK_OPEN = WORDMARK_ULTIMATE
...
/** Rendered width of the full wordmark: ultimate half + 1-col gap + claude half. */
export const WORDMARK_WIDTH =
  WORDMARK_ULTIMATE[0].length + 1 + WORDMARK_CLAUDE[0].length
