 ...
 *
 * ultimate-claude shows opt-in "sponsored tips" during inference waits; a viewer who
 ...
 * stored in ultimate-claude config), sent as the `x-earn-code` header.
 *
...
const COMMON_HEADERS = (earnCode: string): Record<string, string> => ({
  ...
  'user-agent': 'gitlawb-ultimate-claude-ads',
