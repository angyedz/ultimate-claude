...
const SAVED_ENV = {
  ...
  ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS:
    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS,
...
describe('getAutoCompactFailureCooldownMs', () => {
  test('uses valid positive integer override above the floor', async () => {
    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = ' 15000 '
  ...
  test('rejects overrides below the minimum cooldown floor', async () => {
    ...
    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '5000'
    ...
    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '10000'
    expect(getAutoCompactFailureCooldownMs()).toBe(10_000)

    // One below the floor is rejected.
    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '9999'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )
  })
  ...
  test('ignores partial or invalid override values', async () => {
    ...
    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '5000ms'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )

    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '-1'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )

    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '1.5'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )

    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '1e3'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )

    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '0x10'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )

    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '0b10'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )

    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '+5'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )

    process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS = '5.0'
    expect(getAutoCompactFailureCooldownMs()).toBe(
      AUTOCOMPACT_FAILURE_COOLDOWN_MS,
    )
  })
