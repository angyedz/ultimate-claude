...
// Minimum cooldown override allowed via ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS.
...
export function getAutoCompactFailureCooldownMs(): number {
  const override = process.env.ULTIMATE_CLAUDE_AUTOCOMPACT_FAILURE_COOLDOWN_MS
  if (override) {
