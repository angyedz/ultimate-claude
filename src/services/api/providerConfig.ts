...
type ReasoningEffort = 'low' | 'medium' | 'high' | 'xhigh' | 'max' | 'ultracode'
...
//
// Set `ULTIMATE_CLAUDE_LOCAL_FAST_PATH=1` to force it on, `=0` to force off, or
...
const LOCAL_FAST_PATH_ENV = 'ULTIMATE_CLAUDE_LOCAL_FAST_PATH'
