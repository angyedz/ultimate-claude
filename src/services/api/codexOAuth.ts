...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Claude Code now.</p>
    <p>Claude Code will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Claude Code.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Claude Code.</p>
  </body>
</html>`
}
