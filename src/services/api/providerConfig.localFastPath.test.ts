...
const ENV_VAR = 'ULTIMATE_CLAUDE_LOCAL_FAST_PATH'
...
describe('getLocalFastPathConfig — explicit env override', () => {
  test('ULTIMATE_CLAUDE_LOCAL_FAST_PATH=1 forces on against a public host', () => {
  ...
  test('ULTIMATE_CLAUDE_LOCAL_FAST_PATH=0 forces off against localhost', () => {
