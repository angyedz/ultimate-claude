export const vi = {
  ...
  'commands.doctor.description':
    'Chẩn đoán và xác minh cài đặt Claude Code',
  ...
  'commands.insights.description':
    'Tạo báo cáo phân tích các phiên Claude Code',
  ...
  'commands.plugin.description': 'Quản lý plugin Claude Code',
  ...
  'commands.stats.description':
    'Hiện thống kê sử dụng và hoạt động Claude Code',
  'commands.status.description':
    'Hiển thị trạng thái Claude Code bao gồm phiên bản, mô hình, tài khoản, kết nối API và trạng thái công cụ',
  'commands.statusline.description':
    'Thiết lập giao diện dòng trạng thái của Claude Code',
  'commands.stickers.description': 'Đặt mua sticker Claude Code',
  ...
  'commands.wiki.description':
    'Khởi tạo và kiểm tra wiki dự án Claude Code',
