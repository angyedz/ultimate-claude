export const en = {
  ...
  'help.bash_mode': '! for bash mode',
  'help.commands': '/ for commands',
  'help.file_paths': '@ for file paths',
  'help.background': '& for background',
  'help.btw': '/btw for side question',
  'help.clear_input': 'double tap esc to clear input',
  'help.auto_accept_edits': 'to auto-accept edits',
  'help.verbose_output': 'for verbose output',
  'help.toggle_tasks': 'to toggle tasks',
  'help.undo': 'to undo',
  'help.suspend': 'ctrl + z to suspend',
  'help.paste_images': 'to paste images',
  'help.switch_model': 'to switch model',
  'help.toggle_fast_mode': 'to toggle fast mode',
  'help.stash_prompt': 'to stash prompt',
  'help.external_editor': 'to edit in $EDITOR',
  'help.keybindings': '/keybindings to customize',
  'help.terminal': 'for terminal',

  // Logo screen
  'logo.debug_mode': 'Debug mode enabled',
  'logo.logging_to': 'Logging to: ',
  'logo.tmux_session': 'tmux session: ',
  'logo.tmux_detach': 'Detach:',
  ...
  'repl.pasting_text': 'Pasting text…',
  'repl.on': 'on',
  'repl.shortcuts_hint': '? for shortcuts',
  'repl.vs_code_mac_hint': 'set macOptionClickForcesSelection in VS Code settings',
  'repl.voice_hold_to_speak': 'hold {key} to speak',

  // Shortcut action labels
  'shortcut.action.toggleTranscript': 'toggle transcript',
  'shortcut.action.toggleTodos': 'toggle tasks',
  'shortcut.action.undo': 'undo',
  'shortcut.action.stash': 'stash prompt',
  'shortcut.action.cycleMode': 'cycle modes',
  'shortcut.action.modelPicker': 'switch model',
  'shortcut.action.fastMode': 'toggle fast mode',
  'shortcut.action.externalEditor': 'edit in $EDITOR',
  'shortcut.action.toggleTerminal': 'toggle terminal',
  'shortcut.action.imagePaste': 'paste images',
  'shortcut.action.cycle': 'cycle',
  'shortcut.action.copy': 'copy',
  'shortcut.action.native select': 'native select',
  'shortcut.action.speak': 'speak',
  'shortcut.action.view tasks': 'view tasks',
  'shortcut.action.manage': 'manage',
  'shortcut.action.interrupt': 'interrupt',
  'shortcut.action.stop agents': 'stop agents',
  'shortcut.action.return to team lead': 'return to team lead',
