...
// '.claude/...' and drifted from the canonical '.ultimate-claude/...'.
//
...
//      literal '.ultimate-claude/...' (catches a settings.ts regression).
...
const EXPECTED = {
  projectSettings: '.ultimate-claude/settings.json',
  localSettings: '.ultimate-claude/settings.local.json',
} as const
...
test('getRelativeSettingsFilePathForSource returns the canonical .ultimate-claude/ paths', () => {
