...
export type Props = {
   ...
   * project-scoped (written to the assistant's .ultimate-claude/settings.json via
   * install.ts) and should not leak to the user's global ~/.ultimate-claude/settings.json.
   */
